...
public class EnemyBoss extends GameObject{
	...
	public void tick() {
		...
		//boss goes to center of the screen, once the timer reaches 0, boss vel will stop, so in 80 ticks
		// the boss will stop around the upper middle of the screeen
		if(timer <= 0)  velY = 0;
		else timer--;
		
		//a few ticks after the boss reaches the middle of the screen, they will begin to go left and right
		if(timer <= 0) timer2--;
		if(timer2 <= 0)
		{
